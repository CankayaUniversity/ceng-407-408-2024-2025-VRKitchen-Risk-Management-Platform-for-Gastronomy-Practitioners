...
# First query
query_data_1 = {
    "query_text": "How to make rice and chicken?",
...
if submit_response_1.status_code == 500:
    ...
    if submit_response_1.status_code == 200:
        ...
        print("Response:", submit_result_1)
        ...
        query_data_2 = {
            "query_text": "I boiled the water, what's the next step?",
